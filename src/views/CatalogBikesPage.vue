...
const { items, tempItems, loader } = useGetAllBikes()
...
const bannerTitle = ref('Электровелосипеды')
</script>

<template>
  <NavigationTopPage :title="title" :path="CATALOG_ROUTE" :title2="'Электровелосипеды'" />
