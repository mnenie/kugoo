...
const { items, tempItems, loader } = useGetAllScooters()
...
const bannerTitle = ref('Электросамокаты')
</script>

<template>
  <NavigationTopPage :title="title" :path="CATALOG_ROUTE" :title2="'Электросамокаты'" />
