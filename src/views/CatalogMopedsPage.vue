...
const { items, tempItems, loader } = useGetAllMopeds()
...
const bannerTitle = ref('Электроскутеры')

</script>

<template>
  <NavigationTopPage :title="title" :path="CATALOG_ROUTE" :title2="'Электроскутеры'" />
