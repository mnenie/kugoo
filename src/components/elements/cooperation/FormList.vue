...
<template>
  <form @submit.prevent="$emit('onSubmit')"
    ...
    <InputPurple :placeholder="place" style="max-width: 100%;" v-bind="phone" :value="phoneValue"
    ...
    <InputPurple v-if="isEmail" :placeholder="placeEmail" style="max-width: 100%;" v-bind="email" :value="emailValue"
    ...
    <ButtonLargeWhite style="width: 100%;">{{ btnTitle }}</ButtonLargeWhite>
