  ...
  <div class="send_content">
    <div class="container">
      <div class="blocks">
        ...
        <div class="parts">
          <TopCityPart v-if="btnsFilter4[0].active || btnsFilter4[1].active || btnsFilter4[2].active" :filters="btnsFilter4" />
          <TopPartRegion v-if="btnsFilter4[3].active" />
          <TopPartAfter v-if="btnsFilter4[4].active" />
