import { computed, withDirectives, openBlock, createElementBlock, createElementVNode, normalizeStyle, unref, vShow, useCssVars, createStaticVNode } from 'vue';
...
return (_ctx, _cache) => {
  return (openBlock(), createElementBlock("div", _hoisted_1$b, _hoisted_12))
}
}
...
return (_ctx, _cache) => {
  return (openBlock(), createElementBlock("div", _hoisted_1$8, [
    createElementVNode("div", {
      ...
      style: normalizeStyle(unref(container))
    }, [
      createElementVNode("div", {
        class: "pacman-body",
        style: normalizeStyle(unref(pacmanBody))
      }, null, 4 /* STYLE */),
      createElementVNode("div", {
        class: "pacman-mouth",
        style: normalizeStyle(unref(pacmanMouth))
      }, [
        createElementVNode("div", {
          class: "pacman",
          style: normalizeStyle(unref(pacman))
        }, null, 4 /* STYLE */)
      ], 4 /* STYLE */)
    ], 4 /* STYLE */),
    createElementVNode("div", {
      class: "dot",
      style: normalizeStyle(unref(dot))
    }, null, 4 /* STYLE */)
  ]))
}
}
...
export { script$h as BeatLoader, script$g as BounceLoader, script$f as ClipLoader, script$e as DotLoader, script$d as FadeLoader, script$c as GridLoader, script$b as JellyfishLoader, script$a as MoonLoader, script$8 as Pacman2Loader, script$9 as PacmanLoader, script$7 as PulseLoader, script$6 as RingLoader, script$5 as RiseLoader, script$4 as RotateLoader, script$3 as ScaleLoader, script$2 as SkewLoader, script$1 as SquareLoader, script as SyncLoader, vue3Spinner };
